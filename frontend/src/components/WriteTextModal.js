...
const WriteTextModal = ({ isOpen, onClose, onPostCreated, onBusinessAdded, businesses = [] }) => {
  ...
  const onSubmit = async (data) => {
    ...
    //   console.log('Write Text form data:', data);
      ...
      console.log('API URL:', 'http://https://future-content-creator-2.onrender.com//api/prompts/copy');

      const res = await axios.post('http://https://future-content-creator-2.onrender.com//api/prompts/copy', promptDetails);
